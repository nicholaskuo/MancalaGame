...
public class ScorePit extends JPanel {
    private final static String IMG_FILE = "files/topScore.jpg";
    ...
    public int randomYCoord() {
        return (int) (Math.random() * (85 - 20 + 1) + 20);
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        // check if numberOfMarbles is less than listOfMarbles stored
        // if so, remove marbles
